 ...
 */
public record AlbumDto(Long id, String name, String releaseDate, String coverImageUrl, String genre, String description, List<SongDtoSimple> songs) implements Serializable {
